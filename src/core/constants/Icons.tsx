...
export const icons = {
    ...
    arrowDownFill: React.lazy(() => import(pathInitial + '/arrow-down-fill.svg?react')),
    arrowLeftFill: React.lazy(() => import(pathInitial + '/arrow-left-fill.svg?react')),
    arrowRightFill: React.lazy(() => import(pathInitial + '/arrow-right-fill.svg?react')),
    arrowUp: React.lazy(() => import(pathInitial + '/arrow-up.svg?react')),
    arrowUpFill: React.lazy(() => import(pathInitial + '/arrow-up-fill.svg?react')),
    ...
    infoCircle: React.lazy(()=>import (pathInitial + '/info-circle.svg?react')),
    ...
    moreOption: React.lazy(()=> import (pathInitial + '/more-option.svg?react')),
    ...
    emptyState: React.lazy(()=>import (pathInitial + '/empty-state.svg?react')),
    download: React.lazy(()=>import (pathInitial + '/download.svg?react')),
    upload: React.lazy(()=>import (pathInitial + '/upload.svg?react')),
};